@extends('policy.policy-layout')

@section('title', 'Cookie Policy')

@section('content')
    <p class="lead">
        This Cookie Policy explains how Trinitive ("we", "us", and "our") uses cookies and similar technologies to recognize you when you visit our website. It explains what these technologies are and why we use them, as well as your rights to control our use of them.
    </p>
    ...
    <p>
        Cookies set by the website owner (in this case, Trinitive) are called "first-party cookies". Cookies set by parties other than the website owner are called "third-party cookies". Third-party cookies enable third-party features or functionality to be provided on or through the website (e.g., advertising, interactive content, and analytics). The parties that set these third-party cookies can recognize your computer both when it visits the website in question and also when it visits certain other websites.
    </p>
    ...
    <h2>Do We Update This Cookie Policy?</h2>
    <p>
    ...
    <p>
        If you have any questions about our use of cookies or other technologies, please email us at contact@trinitive.com or use the contact form on our website.
    </p>
@endsection
