    ...
    <div class="container mx-auto py-32">
        <div class="max-w-3xl">
            ...
            <div class="flex space-x-4">
                <a href="#contact" class="px-8 py-4 bg-gray-900 text-white rounded hover:bg-gray-800 transition-colors">Schedule a Consultation</a>
                <a href="#about" class="px-8 py-4 border border-gray-900 rounded hover:bg-gray-100 transition-colors">Learn More</a>
            </div>
        </div>
    </div>
</section>
