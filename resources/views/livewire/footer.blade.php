<footer class="w-full bg-gray-900 text-white" id="contact">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
                ...
                <div>
                    ...
                    <ul class="space-y-2">
                        ...
                        <li><a href="#services" class="text-gray-400 hover:text-white">Business Microservices</a></li>
                        <li><a href="#services" class="text-gray-400 hover:text-white">API Integration</a></li>
                    </ul>
                </div>
...
{{--                            </svg>--}}
{{--                        </a>--}}
                        <a href="https://www.linkedin.com/company/trinitive/about/" class="text-gray-400 hover:text-white">
                            <svg class="w-6 h-6" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
