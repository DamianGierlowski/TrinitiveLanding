    ...
    <div class="container mx-auto px-6">
        ...
        <div class="grid md:grid-cols-3 gap-8">
            <div class="border p-6 rounded-lg">
                ...
                <p class="text-sm text-gray-700">Custom web applications built with modern frameworks</p>
            </div>
            ...
            <div class="border p-6 rounded-lg">
                ...
                <h3 class="font-bold mb-2">API Integration</h3>
                <p class="text-sm text-gray-700">Seamless third-party service integration</p>
            </div>
        </div>
    </div>
</section>
